# itw3 Blockchain Stats

iTw3 Blockchain Stats utlity exports daily statistics for the iTw3 blockchain from creation through current state.

## Usage:

See also the utility's help option. `itw3-blockchain-stats --help`
...
- `itw3-blockchain-stats > stats-$(date +'%Y-%m-%d').csv`
- `itw3-blockchain-stats | save-to-database.sh`
